    ...
    <div class="container-fluid background py-5">
      ...
      <section>
        <h3>
          ...
          <span class="fw text-secondary"> | Admin Panel Management</span>
        </h3>
      ...
      <div class="login-form">
        ...
        <div class="mt-4">
              ...
              <button v-else @click="GoogleSignIn" class="btn btn-outline-primary w-100 px-4 py-3">
      ...
      <div class="row">
        <div class="col-6 offset-3">
          <div class="bg-white rounded-2 p-5">
            <h3>
              <span class="fw-bold ">Karaoke
                <b-icon icon="mic"></b-icon>
              </span>
              <span class="fw-lighter text-secondary"> | Admin Panel Management</span>
            </h3>
            <div class="mt-4">
              <div v-if="isLoading" class="text-center p-5">
                <div class="spinner-border text-secondary" role="status">
    ...
    <div class="container">
      <div class="overlay-container">
        ...
        <div class="mt-4">
            ...
            <button v-else @click="GoogleSignIn" class="btn btn-outline-primary w-100 px-4 py-3 mt-5">
              <b-icon icon="google"></b-icon>
              Sign-in with Google
            </button>
          </div>
