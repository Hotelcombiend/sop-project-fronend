<template>
    <div class="wrapper2">
            ...
            <!-- <p>วันที่จอง: {{Homepagedata.reverdate}}</p> -->
            <!-- <h5>วันที่จอง</h5> -->
            
            <div class="input_group2">
                <h5>วันที่จอง: </h5>
                <p>{{Homepagedata.reverdate}}</p>
            </div>
            <div class="input_group2">
            ...
            <div class="input_group2">
                ...
                <p>{{Homepagedata.drinkset.fname}}</p>
            </div>
            <div class="input_group2">
                <h5>ชุดอาหาร: </h5>
                <p>{{Homepagedata.foodset.name}}</p>
            </div>
            <div class="input_group2">
                <h5>ชุดเครื่องเสียง: </h5>
                <p>{{Homepagedata.soundset}}</p>
            </div>
            <div class="input_group2">
            ...
            <b-button  class="mt-3 " id="show-btn" @click="UsercreatOrder()">ยืนยันการจอง</b-button>
      ...
      methods:{
        UsercreatOrder(){
            const data = {
                ...
                phone:'08000000',
                status:"pending",
                room:this.Homepagedata.chooseroom,
